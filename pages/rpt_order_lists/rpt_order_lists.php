                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <select name='txtod_status' id='txtod_status' class="form-control">
                                    <?php createCombo("Order","tbl_order_status","ord_status","ord_status"," WHERE id NOT IN (5,6) ORDER BY id DESC",$ord_status); ?>
                                </select>
                            </div>
                            <div class="col-lg-2">
...
<script>
    function sendData(){
        $.ajax({
            type: "POST",
            url: "pages/rpt_order_lists/rpt_order_lists_get.php",
    ...
    function show_details(od_id){
        $.ajax({
            type: "POST",
            url: "pages/rpt_order_lists/rpt_order_list_details.php",
            data: {
                od_id: od_id
            }
        }).done(function(msg) {
