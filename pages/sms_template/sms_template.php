...
<script>
    ...
    $( document ).ready(function() {
		...
		"bLengthChange": true,
		"ajax":{
			url :"pages/sms_template/sms_template_get.php?page=<?php echo $pageid?>", // json datasource
			type: "GET",
            datatype: "json",	
	...
	function add() {
        $.ajax({
            type: "POST",
            url: "pages/sms_template/sms_template_form.php?page=<?php echo $_REQUEST['page']?>",
            data: {},
