            ...
            <div class="card m-b-20">
                <div class="card-body" id="card-body">
                    ...
                    <h4 class="mt-0 header-title d-flex justify-content-between">
                        ...
                        <span><button class="btn btn-primary" onclick="add()">New Order</button></span>
                    </h4>
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                <select name='txtod_status' id='txtod_status' class="form-control">
                                    <?php createCombo("Order","tbl_order_status","id","ord_status","  where id not in (5,6) ORDER BY id DESC",$ord_status); ?>
                                </select>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                <input value='Show Report' type='button' name='btnsubmit' class='forms_button_e btn btn-primary' style="margin-top: 22px;" id="btn-filter">
                            </div>
                        </div>
                    </form>
...
<script>
    $( document ).ready(function() {
		...
		"bLengthChange": false,
		"ajax":{
			url :"pages/order/order_get.php?page=<?php echo $pageid?>", // json datasource
			type: "GET",
            datatype: "json",	
	...
	function add() {
        $.ajax({
            type: "POST",
            url: "pages/order/order_add_form.php",
            data: {},
