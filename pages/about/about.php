      ...
      <div class="col-12">
        <div class="card m-b-20">
          <div class="card-body" id="card-body">
            <h4 class="mt-0 header-title d-flex justify-content-between"> <span>About Us</span>
              <?php if($addper>0){?>
...
$( document ).ready(function() {
		...
		"bLengthChange": false,
		"ajax":{
			url :"pages/about/about_get.php?page=<?php echo $pageid?>", // json datasource
			type: "GET",
            datatype: "json",	
    ...
    function add(){
        $.ajax({
            type: "POST",
            url: "pages/about/about_form.php",
            data: {},
